 ...
 */
public class MultimediaSolidRenderer implements GLSurfaceView.Renderer {
    private static final String TAG = "GLRenderer";
    private final Context context;
    private final MultimediaSolid cube = new MultimediaSolid();
    private long startTime;
    private long fpsStartTime;
    private long numFrames;
    private Integer imgIndex = 0;

    MultimediaSolidRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        if (imgIndex == 0) {
            MultimediaSolid.loadTexture(gl, context, R.drawable.ic_action_play_over_video);
            imgIndex++;
        } else if (imgIndex > 0) {
            MultimediaSolid.loadTexture(gl, context, R.drawable.ic_launcher);
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (fpsElapsed > 60 * 1000) { // every 60 seconds
